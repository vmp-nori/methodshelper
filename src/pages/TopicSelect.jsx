  ...
  return (
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: '#0e0e0e', position: 'relative' }}>
      ...
      <main style={{
        ...
        height: '100%',
        overflowY: 'auto',
        padding: isMobile ? '80px 24px' : '52px 72px',
        marginRight: isMobile ? 0 : 320,
        zIndex: 1,
      }}>

        {/* Top bar — space for the persistent wordmark on the left */}
        <div style={{ display: isMobile ? 'none' : 'flex', alignItems: 'center', justifyContent: 'flex-end', marginBottom: 56 }}>
          <button
            onClick={() => navigate('/')}
            style={{
        ...
        <header style={{ marginBottom: isMobile ? 32 : 48 }}>
          ...
          <h1 style={{
            ...
            fontSize: isMobile ? 36 : 52, fontWeight: 700,
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    padding: isMobile ? '12px 20px' : '10px 24px 10px 32px',
                    background: isHov ? '#191a1a' : '#131313',
                    borderRadius: isMobile ? 12 : 9999,
                ...
                >
                  ...
                  {/* Progress + button */}
                  <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 12 : 32, flexShrink: 0 }}>
                    {!isMobile && (
                    ...
                    <button
                      ...
                      style={{
                        padding: isHov && !isMobile ? '10px 28px' : '10px 14px',
                        borderRadius: 9999,
                        ...
                        whiteSpace: 'nowrap',
                        minWidth: isMobile ? 36 : 44, height: isMobile ? 36 : 44,
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                      }}
                    >
                      {isHov && !isMobile ? 'Start' : '▶'}
                    </button>
                  </div>
                </div>
              )
